...
export function AppShell({
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden lg:grid lg:grid-cols-[280px_minmax(0,1fr)]">
      <aside className="hidden border-r border-border/60 bg-secondary/40 px-4 py-5 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.03] lg:sticky lg:top-0 lg:flex lg:h-screen lg:flex-col lg:overflow-y-auto">
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isActive && "bg-primary text-primary-foreground shadow-sm shadow-primary/20 group-hover:text-primary-foreground"
                  )}
                >
      ...
      <div className="flex min-w-0 flex-col overflow-x-hidden">
        <header className="sticky top-0 z-30 border-b border-border/60 bg-white/80 px-3 py-2.5 pt-[calc(0.625rem+env(safe-area-inset-top))] shadow-sm shadow-black/[0.03] backdrop-blur-xl dark:border-white/10 dark:bg-black/50 lg:hidden">
        ...
        <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border/60 bg-white/85 px-2 pb-[max(env(safe-area-inset-bottom),0.5rem)] pt-2 shadow-[0_-8px_24px_rgba(0,0,0,0.06)] backdrop-blur-xl dark:border-white/10 dark:bg-black/60 lg:hidden">
