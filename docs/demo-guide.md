...
- 学习资料库：上传试卷、讲义、错题照片，或保存网盘/学校链接。
- 孩子自我评价：孩子自己记录心情、投入、掌握程度和下一步。
- 家教课后反馈：老师每次课后记录重点、表现、作业和下次方向。

今天 demo 的文件本体保存在当前浏览器 IndexedDB；正式私有在线版会把文件迁移到 Supabase Storage，保证家长多设备可访问。
